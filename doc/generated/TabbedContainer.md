#### TabbedContainer (com.ankamagames.dofusarena.ud.class)

| Attribute Name | Type | Description | Default Value |
|-----|----|---|---|
|``pixmapAlignment``|``BO``|        |        |
|``scrollButtonsNearby``|``boolean``|        |        |
|``scrollButtonsPositionedBeforeTabs``|``boolean``|        |        |
|``selectedTabIndex``|``int``|        |        |
|``tabsAlignment``|``BP``|        |        |
|``tabsLabelAlignment``|``Alignment9``|        |        |
|``tabsPosition``|``BO``|        |        |
|``tabsSizesEquilibrate``|``boolean``|        |        |
|``textOrientation``|``aiq``|        |        |
