#### MessageBox (com.ankamagames.dofusarena.aAB.class)

| Attribute Name | Type | Description | Default Value |
|-----|----|---|---|
|``canBePushedToTop``|``boolean``|        |        |
|``movable``|``boolean``|        |        |
|``stickWithinDisplayBounds``|``boolean``|        |        |
|``stickWithinRootContainer``|``boolean``|        |        |
|``horizontalDialog``|``String``|        |        |
|``verticalDialog``|``String``|        |        |
#### Inherited from RootContainer (com.ankamagames.dofusarena.Ex.class)
