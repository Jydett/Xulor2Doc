#### RadioButton (com.ankamagames.dofusarena.DL.class)

| Attribute Name | Type | Description | Default Value |
|-----|----|---|---|
|``groupId``|``String``|        |        |
|``value``|``String``|        |        |
#### Inherited from ToggleButton (com.ankamagames.dofusarena.cB.class)

| Attribute Name | Type | Description | Default Value |
|-----|----|---|---|
|``selected``|``boolean``|        |        |
#### Inherited from Button (com.ankamagames.dofusarena.aqq.class)
