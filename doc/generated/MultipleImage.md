#### multipleImage (com.ankamagames.dofusarena.anA.class)

| Attribute Name | Type | Description | Default Value |
|-----|----|---|---|
|``modulationColor``|``Color``|        |        |
|``imagePath``|``String``|        |        |
|``manualInnerMove``|``boolean``|        |        |
|``useInnerMoveTween``|``boolean``|        |        |
|``shrinkToImageWidth``|``boolean``|        |        |
|``shrinkToImageHeight``|``boolean``|        |        |
|``toggleInnerMoveOnClick``|``boolean``|        |        |
